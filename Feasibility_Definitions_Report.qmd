...
<!--# need a general introduction stating the objective and contents of the document -->
...
**Environmental suitability** refers to the capacity of a site to support a tree species.<!--# these two definitions don't make a distinction. they seem to be the same thing -->

The species feasibility ratings are focused on the establishment phase of reforestation when trees are most vulnerable to environmental stresses, but these ratings should also reflect likely success through rotation <!--# i changed maturation to rotation because Mike Ryan had thought maturation meant 120+ years --> (assuming non-climate changed future). The primary rating criterion is an assessment of the probability of successful establishment and growth of a species across the entire environmental space of a site series. It is assumed that the species lists in the CFRG are an accurate list of the feasible species for each site series. However, the CFRG ratings reflect “best species” for saw log production or “best available species” for a site series. For this reassessment, species are initially assumed to be feasible across all examples of a site series (an E1 rating) <!--# all species on all sites get E1? or just the species with a primary rating in CFRG? needs clarification -->. A species may then be down-rated using several criteria indicating environmental constraints (e.g., CFRG footnotes indicating site, topographic, or geographic restrictions, or observed 'decline' of species prior to rotation). Deciduous tree species, which have been less comprehensively rated in the CFRG, are given as thorough a rating assessment as conifers through all BGCs.
...
-   **E4** – Minimal feasibility. Species at or beyond the limits of the species' climatic or site tolerance <!--# clearer wording was required. the terms periphery, edge, and threshold were used in E2, 3, and 4, and they are all subjective. go with one term ("limit") and apply it logically  -->
    ...
    -   Expected to be feasible outside of the species current natural range based on modelling or (preferably) successful field trials. These species may receive E1-E3 feasibility ratings upon further review of available information: Griesbauer and MacKenzie: Type 1 off-site species criteria.
-   **E5** – No/minimal environmental feasibility based on species autecology. Environmental constraints generally preclude successful establishment of untended stands. Species not present in natural forests. E5 has been assigned only if the species was previously ranked as suitable for a site series in the Reference Guide and is reassessed as unfeasible. E5 rating is assumed where a species has a null rating in the tables.

## Feasibility Rating Process

Initial feasibility ratings were assigned <!--# when? --> by A. Banner (Coast and North Area), T. Braumandl (Kootenay-Boundary, Thompson-Okanagan), W. MacKenzie (Alberta), D. Meidinger (USA) for all regions using the following information resources.
...
Subsequent review of this output <!--# when? by whom? --> led to some clarification of definitions and modifications to initial ratings attributes. The initial ratings were then reviewed <!--# when? --> by various regional experts. Complete reviews occurred in the Coast Area (H. Klassen, S. Saunders,), Thompson-Okanagan (M. Ryan), Northeast and Alberta (R. Kabzems). Spot checks were undertaken in Omineca (B. Rogers, H. Griesbauer), Skeena (E. Lilles), Cariboo Regions (R. Coupe). D. Meidinger did a second assessment of USA ratings <!--# when? -->.
