...
BGCZone <-fread(paste0(cloud_dir,"ccissv13_files/WNA_BGCs_Info_v13_1.csv"), data.table=FALSE) #%>% dplyr::select(Zone, BGC)

ESuit <- fread(paste0(cloud_dir,"ccissv13_files/Feasibility_v13_1.csv"), data.table=FALSE) %>% dplyr::filter(!outrange == TRUE) %>% 
  distinct() %>%
...
E1 <-fread(paste0(cloud_dir,"ccissv13_files/Edatopic_v13_1.csv"),  na.strings= c("", "NA")) %>% distinct()
